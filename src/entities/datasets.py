...
class Replica(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        return index, color_data, depth_data, self.poses[index],None,depth_data
...
class Kitti(BaseDataset):
    def __init__(self, dataset_config: dict):
        ...
        # denoising_unet = UNet2DConditionModel_main.from_pretrained(self.args.pretrained_model_name_or_path, subfolder="unet",
    ...
    def __getitem__(self, index):
        ...
        color_data = np.asarray(imageio.imread(self.color_paths[index]), dtype=float)
        print(self.color_paths[index])
        color_path = self.color_paths[index]
        depth_path = color_path.replace("_2", "_2_predict")
        ...
        return index, color_data, depth_pred, self.poses[index], point_camera, depth_pred
