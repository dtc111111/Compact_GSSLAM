        ...
        if sample:
            ...
            if time_idx > 0 and not config['tracking']['use_gt_poses']:
                ...
                while True:
                    ...
                    loss, variables, losses, _ = get_loss(params, tracking_curr_data, variables, iter_time_idx, config['tracking']['loss_weights'],
            ...
            if time_idx == 0 or (time_idx+1) % config['map_every'] == 0:
                ...
                for iter in range(num_iters_mapping):
                    ...
                    # Loss for current frame
                    loss, variables, losses, _ = get_loss(params, iter_data, variables, iter_time_idx, config['mapping']['loss_weights'],
