...
config = dict(
    ...
    data=dict(
        basedir="/dataset/ScanNet/scans",
        gradslam_data_cfg="/data/SplaTAM_cyh/configs/data/scannet.yaml",
        sequence=f"{scene_name}/image",
        desired_image_height=480,
        desired_image_width=640,
        # desired_image_height=968,
        # desired_image_width=1296,
        start=0,
        end=-1,
        stride=1,
        num_frames=-1,
    ...
    mapping=dict(
        ...
        pruning_dict=dict( # Needs to be updated based on the number of mapping iterations
            ...
            mask_reset_cycle = keyframe_every * (mapping_window_size + 2),
            mask_start = keyframe_every * (mapping_window_size + 2),
            mask_stop = 30 * keyframe_every * (mapping_window_size + 2),
            mask_per = keyframe_every,
            reset_iter = mapping_iters - 1, 
        ),
