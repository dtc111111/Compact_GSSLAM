...
config = dict(
    workdir=f"/data/SplaTAM_cyh/experiments/{group_name}",
    run_name=run_name,
    seed=seed,
    ...
    wandb=dict(
        ...
        project="SplaTAM",
        group=group_name,
        name=run_name + "cyh_tum_eval",
        save_qual=False,
        eval_save_qual=True,
    ),
    data=dict(
        basedir="/dataset/TUM_RGBD",
        gradslam_data_cfg=f"/data/SplaTAM_cyh/configs/data/TUM/{scene_name}.yaml",
    ...
    mapping=dict(
        ...
        pruning_dict=dict( # Needs to be updated based on the number of mapping iterations
            ...
            mask_stop = 4 * keyframe_every * (mapping_window_size + 2),
