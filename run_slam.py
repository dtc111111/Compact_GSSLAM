...
def get_args():
    ...
    parser.add_argument('--config_path', type=str, default="configs/KITTI/kitti_01.yaml",
                        help='Path to the configuration yaml file')
    # parser.add_argument('--config_path', type=str, default="configs/Replica/room1.yaml",
    #                     help='Path to the configuration yaml file')
    parser.add_argument('--input_path', default="/data/Replica/room1/")
    parser.add_argument('--output_path', default="output/kitti/00")
    # parser.add_argument('--output_path', default="output/Replica/room1_0521")
